...
def load_word2vec():
    try:
        wv_model = Word2Vec.load('/root/data1/sty/datasets/workplace/GoogleNews', mmap='r')
    except:
        wv_model = Word2Vec.load_word2vec_format(
            '/root/data1/sty/datasets/workplace/GoogleNews-vectors-negative300.bin', binary=True)
